...
urlpatterns = [
    ...
    path('wiki/article/add', ArticleCreateView.as_view(), name='article'),
    path('wiki/article/<int:pk>/delete', ArticleDeleteView.as_view(), name='article'),
    path('wiki/article/gallery', ArticleGalleryView.as_view(), name='article'),
]
